...
class TestVersioning(unittest.TestCase):
    ...
    def test_alias(self):
        ...
        self.assertTrue('createdTime' in r_data)
        self.assertTrue('lastModifiedTime' in r_data)
    ...
    def test_get_service(self):
        ...
        service = self.client.get_service(self._test_service_name, qualifier=v1, headers={'x-fc-trace-id': str(uuid.uuid4())}).data
        ...
        service = self.client.get_service(self._test_service_name, qualifier=v2).data
        self.assertEqual(service['serviceName'], self._test_service_name)
        ...
        service = self.client.get_service(self._test_service_name, qualifier="test").data
        self.assertEqual(service['serviceName'], self._test_service_name)
        self.assertEqual(service['description'], "test service v1 desc")
    ...
    def check_function(self, functionName, desc, checksum, qualifier = None,  runtime = 'python2.7'):
        function = self.client.get_function(self._test_service_name, functionName, qualifier=qualifier)
        function = function.data
        ...
        code = self.client.get_function_code(self._test_service_name, functionName, qualifier=qualifier)
        code = code.data
    ...
    def test_invoke_function(self):
        ...
        data = r.data
        v1 = data['versionId']
        self.client.create_alias(self._test_service_name, "test", v1, "test alias", {v1: 1.0})
        ...
        data = r.data
        v2 = data['versionId']
        self.client.create_alias(self._test_service_name, "prod", v2, "test alias", {v2: 1.0})


        r = self.client.invoke_function(self._test_service_name, functionName)
        self.assertEqual(r.data.decode('utf-8'), 'new hello world')

        r = self.client.invoke_function(self._test_service_name, functionName, qualifier=v1)
        self.assertEqual(r.data.decode('utf-8'), 'hello world')

        r = self.client.invoke_function(self._test_service_name, functionName, qualifier="test")
        self.assertEqual(r.data.decode('utf-8'), 'hello world')


        r = self.client.invoke_function(self._test_service_name, functionName, qualifier=v2)
        self.assertEqual(r.data.decode('utf-8'), 'new hello world')
    ...
    def test_trigger(self):
        ...
        update_trigger_resp = self.client.update_trigger(self._test_service_name, functionName, trigger_name, 
                                                         trigger_config_update, invocation_role, qualifier=v1).data

        self.check_trigger_response(update_trigger_resp, trigger_name, trigger_type, trigger_config_update, source_arn,
                                    invocation_role, v1)

        update_trigger_resp = self.client.update_trigger(self._test_service_name, functionName, trigger_name, 
                                                         trigger_config_update, invocation_role,  qualifier="test").data
        ...
        update_trigger_resp = self.client.update_trigger(self._test_service_name, functionName, trigger_name, 
                                                         trigger_config_update, invocation_role, qualifier=v2).data
        ...
        update_trigger_resp = self.client.update_trigger(self._test_service_name, functionName, trigger_name, 
                                                         trigger_config_update, invocation_role, qualifier="prod").data
