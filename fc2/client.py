...
class Client(object):
    ...
    def create_function(
            ...
            description=None, memorySize=256, timeout=60, headers={}, environmentVariables={}):
        """
        Create a function.
        ...
        :param environmentVariables: (optional, dic) the environment variables of the function, both key and value are string type.
        :param headers, optional
            1, 'x-fc-trace-id': string (a uuid to do the request tracing)
            2, user define key value
        :return: FcHttpResponse
